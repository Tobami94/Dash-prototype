          ...
          <ul>
            <li>
              <Link
                ...
                <span className="text-primary-305">Home</span>
              </Link>
            </li>
            <li>
              <Link
                ...
                className="flex items-center gap-4 py-2 px-4 rounded-lg hover:bg-secondary-900 transition-colors">
                <RiBarChart2Line className="text-primary-305" />{" "}
                <span className="text-primary-305">Analytics</span>
              </Link>
            </li>
            <li>
              <button
                ...
                <span className="flex items-center gap-4">
                  ...
                  <span className="text-primary-305">Social Media</span>
                </span>
                <RiArrowRightSLine
                  className={`mt-1 ${
            ...
            <li>
              <Link
                ...
                <span className="text-primary-305">Technical support</span>
              </Link>
            </li>
            <li>
              <Link
                ...
                <span className="text-primary-305">Calendar</span>
              </Link>
            </li>
          </ul>
        </div>
